...
# -*- encoding: utf-8 -*-
# stub: bible_reference_parser 0.1.4 ruby lib

Gem::Specification.new do |s|
  s.name = "bible_reference_parser"
  s.version = "0.1.4"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Nathan McWilliams"]
  s.date = "2013-09-26"
  s.description = "BibleReferenceParser can parse scriptures passages, such as 'Gen. 1:15-18, 21' to the individual books, chapters and verses in the passage. It also provides validation for invalid book names, chapters, and verses."
  s.email = "nathan.mcwilliams@gmail.com"
  s.extra_rdoc_files = [
    "LICENSE",
    "README.markdown"
  ]
  ...
  s.homepage = "http://github.com/endium/bible_reference_parser"
  s.require_paths = ["lib"]
  s.rubygems_version = "2.1.3"
  s.summary = "Parsing and validation for scripture passages."
